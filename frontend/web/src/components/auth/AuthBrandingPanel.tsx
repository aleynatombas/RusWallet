...
export function AuthBrandingPanel({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        'relative flex min-h-[42vh] flex-col overflow-hidden bg-gradient-to-br from-slate-50 via-white to-sky-50/45 font-display dark:from-slate-950 dark:via-slate-950 dark:to-slate-950 lg:min-h-screen lg:min-w-0',
        className
      )}
    >
      {/* Yumuşak renk yıkaması */}
      <div
        className="pointer-events-none absolute inset-0 bg-gradient-to-br from-sky-100/35 via-transparent to-cyan-100/25 dark:from-slate-950 dark:via-sky-950/30 dark:to-slate-900"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_85%_60%_at_18%_12%,rgba(14,165,233,0.13),transparent_58%)] dark:bg-[radial-gradient(ellipse_85%_60%_at_20%_15%,rgba(56,189,248,0.11),transparent_55%)]"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_72%_52%_at_88%_78%,rgba(6,182,212,0.1),transparent_52%)] dark:bg-[radial-gradient(ellipse_70%_50%_at_85%_75%,rgba(125,211,252,0.09),transparent_50%)]"
        aria-hidden
      />

      {/* Soyut grafik çizgisi */}
      <svg
        className="pointer-events-none absolute bottom-[12%] left-[-5%] h-[42%] w-[110%] text-sky-600/25 dark:text-sky-400/22"
        viewBox="0 0 800 200"
      ...
      <div
        className="pointer-events-none absolute inset-0 opacity-[0.045] [background-image:linear-gradient(rgba(15,118,110,0.35)_1px,transparent_1px),linear-gradient(90deg,rgba(15,118,110,0.28)_1px,transparent_1px)] [background-size:48px_48px] dark:opacity-[0.07] dark:[background-image:linear-gradient(rgba(148,163,184,0.4)_1px,transparent_1px),linear-gradient(90deg,rgba(148,163,184,0.35)_1px,transparent_1px)]"
        aria-hidden
      />
      ...
      <div className="relative z-[1] flex flex-1 flex-col justify-between gap-10 p-8 sm:p-10 lg:p-12">
        ...
        <div className="max-w-md space-y-4 lg:py-4">
          <h1 className="font-display text-3xl font-semibold leading-[1.15] tracking-tight text-slate-900 dark:text-white sm:text-4xl lg:text-[2.35rem] lg:leading-tight">
            ...
            <span className="bg-gradient-to-r from-sky-600 via-cyan-500 to-blue-600 bg-clip-text text-transparent dark:from-sky-300 dark:via-cyan-300 dark:to-blue-300">
              tek ekranda
            </span>{' '}
            net gör.
          </h1>
