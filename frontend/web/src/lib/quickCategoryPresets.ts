/**
 * Hazır gider / gelir etiketleri — çekirdek Türkçe alfabetik; Diğer gider / Diğer gelir en sonda.
 */
...
export const QUICK_PRESET_EXPENSE: readonly string[] = [
  ...[...EXPENSE_CORE].sort(sortTr),
  'Diğer gider',
];

export const QUICK_PRESET_INCOME: readonly string[] = [
  ...[...INCOME_CORE].sort(sortTr),
  'Diğer gelir',
];
...
export function quickCategoryViolatesType(
  name: string,
  isIncomeButton: boolean
): string | null {
...
/** Alfabetik gövde; Diğer gider ve Diğer gelir her zaman listenin sonunda. */
